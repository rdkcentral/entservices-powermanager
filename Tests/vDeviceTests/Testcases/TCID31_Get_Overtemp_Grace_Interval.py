"""
/**
 * @file TCID31_Get_Overtemp_Grace_Interval.py
 * @brief L2 PowerManager functional testcase.
 *
 * @testcase TCID31_Get_Overtemp_Grace_Interval
...
def run_test():
    ...
    if isinstance(grace, bool) or not isinstance(grace, int):
        log_error("TCID31_Get_Overtemp_Grace_Interval Failed ❌ (graceInterval missing/not int)")
        return False

    elapsed_time = time.perf_counter() - start_time
    msg = "TCID31_Get_Overtemp_Grace_Interval Passed ✅"
