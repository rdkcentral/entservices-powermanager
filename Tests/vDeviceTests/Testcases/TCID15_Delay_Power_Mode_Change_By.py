"""
/**
 * @file TCID15_Delay_Power_Mode_Change_By.py
 * @brief L2 PowerManager functional testcase for delayPowerModeChangeBy.
 *
 * @testcase TCID15_Delay_Power_Mode_Change_By
...
def run_test():
    ...
    if not is_ok(response):
        log_error("TCID15_Delay_Power_Mode_Change_By Failed ❌ (call did not succeed)")
        return False

    elapsed_time = time.perf_counter() - start_time
    msg = "TCID15_Delay_Power_Mode_Change_By Passed ✅"
