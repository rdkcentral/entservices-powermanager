"""
/**
 * @file TCID35_Delay_Power_Mode_Change_By.py
 * @brief L2 PowerManager functional testcase for delayPowerModeChangeBy.
 *
 * @testcase TCID35_Delay_Power_Mode_Change_By
...
def run_test():
    ...
    if not is_ok(response):
        log_error("TCID35_Delay_Power_Mode_Change_By Failed ❌ (call did not succeed)")
        return False

    elapsed_time = time.perf_counter() - start_time
    msg = "TCID35_Delay_Power_Mode_Change_By Passed ✅"
