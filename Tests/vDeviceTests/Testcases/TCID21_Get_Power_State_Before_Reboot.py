"""
/**
 * @file TCID21_Get_Power_State_Before_Reboot.py
 * @brief L3 PowerManager functional testcase.
 *
 * @testcase TCID21_Get_Power_State_Before_Reboot
...
def run_test():
    ...
    if not isinstance(result, str) or result not in valid_states:
        log_error("TCID21_Get_Power_State_Before_Reboot Failed ❌ (no valid result)")
        return False

    elapsed_time = time.perf_counter() - start_time
    msg = "TCID21_Get_Power_State_Before_Reboot Passed ✅"
