"""
/**
 * @file TCID20_Get_Thermal_State.py
 * @brief L3 PowerManager functional testcase.
 *
 * @testcase TCID20_Get_Thermal_State
...
def run_test():
    ...
    if isinstance(temperature, bool) or not isinstance(temperature, (int, float)):
        log_error("TCID20_Get_Thermal_State Failed ❌ (temperature missing/not numeric)")
        return False

    elapsed_time = time.perf_counter() - start_time
    msg = "TCID20_Get_Thermal_State Passed ✅"
