...
example: git clone https://github.com/rdkcentral/entservices-powermanager.git

2. switch to entservices-<repo-name> directory
example: cd entservices-powermanager
...
uses: rdkcentral/entservices-powermanager/.github/workflows/L1-tests.yml@topic/method_1 /* tf-trigger.yml */

b/ changes in both testframework repo and invidual repo:
Changes mentioned in step (a) above + "Checkout entservices-powermanager-testframework" job in individual repo yml file, ref field to point your powermanager current working branch.
example:
ref: topic/method_1 /* Checkout entservices-testframework job */
ref: topic/method_1 /* Checkout entservices-powermanager-testframework job */
uses: rdkcentral/entservices-powermanager/.github/workflows/L1-tests.yml@topic/method_1 /* tf-trigger.yml */
